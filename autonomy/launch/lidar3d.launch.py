...
from launch_ros.parameters_type import SomeParameterName, SomeParameterValue
from launch_ros.remap_rule_type import SomeRemapRule

SomeRemapRules = list[SomeRemapRule]  # redefined to use List instead of Iterable to get rid of warnings

# redefined to use MutableMapping instead of Mapping to get rid of warnings
_SomeParametersDict = MutableMapping[SomeParameterName, Any]
SomeParametersDict = MutableMapping[SomeParameterName, SomeParameterValue | _SomeParametersDict]


def launch_setup(context: LaunchContext) -> list[LaunchDescriptionEntity]:  # noqa: PLR0915
    ...
    remappings: SomeRemapRules = [
        ("odom", "icp_odom"),
        ("imu", LaunchConfiguration("imu_topic") if imu_used else "imu_not_used"),
    ]
    ...
    shared_parameters: SomeParametersDict = {
        ...
        # 9=KAZE 10=ORB-OCTREE 11=SuperPoint 12=SURF/FREAK 13=GFTT/DAISY 14=SURF/DAISY 15=PyDetector
    ...
    if localization:
        ...
        arguments.append("--delete_db_on_start")  # This will delete the previous database (~/.ros/rtabmap.db)
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description="Use fast slerp interpolation between first and last stamps of the scan for deskewing. "
                        "It would less accruate than requesting TF for every points, but a lot faster. "
                        "Enable this if the delay of the deskewed scan is significant larger than the original scan.",
        ),
