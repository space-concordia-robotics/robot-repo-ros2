...
This package is functionally a lost cause.
I (Will) tried going in and cleaning it up, but it would genuinely be faster to rewrite it from the ground up than to fix the myriad of mistakes happening here.
