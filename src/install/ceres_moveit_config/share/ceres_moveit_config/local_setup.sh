...
: ${AMENT_CURRENT_PREFIX:="/home/liliana/ros2_ws/robot-repo-ros2/src/install/ceres_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ceres_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ceres_moveit_config/environment/path.sh"
