...
#include <sensor_msgs/msg/joy.hpp>
  ...
  Absenc::Absenc() : rclcpp::Node("absenc_node") {
    ...
    AbsencError err = AbsencDriver::openPort(this->get_parameter("absenc_path").as_string().c_str(), s_fd);
    if (err.error != 0) {
...
void Absenc::absEncPollingCallback() {
    AbsencMeasurement absenc_meas_1, absenc_meas_2, absenc_meas_3, absenc_meas_4;

    AbsencError err1 = AbsencDriver::pollSlave(1, &absenc_meas_1, s_fd);
    AbsencError err2 = AbsencDriver::pollSlave(2, &absenc_meas_2, s_fd);
    AbsencError err3 = AbsencDriver::pollSlave(3, &absenc_meas_3, s_fd);
    AbsencError err4 = AbsencDriver::pollSlave(4, &absenc_meas_4, s_fd);
