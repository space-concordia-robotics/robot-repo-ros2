...
static constexpr auto VOLTAGE_MULTIPLIER = 100.0;
...
public:
    ...
    double getBatteryVoltageLevel(size_t idx = 0) const;
    double getBatteryCurrentLevel(size_t idx = 0) const;
    double getBatteryTemp(size_t idx = 0) const;
    ...
    // ------------------------ Rail accessors -------------------------
    double getRailVoltageLevel(size_t idx = 0) const;
    double getRailCurrent(size_t idx = 0) const;
    double getRailPower(size_t idx = 0) const;
    double getRailTemp(size_t idx = 0) const; // firmware does not send; returns 0
